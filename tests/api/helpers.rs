...
impl TestApp {
    ...
    // so we don't expose the underlying reqwest::Response
    ...
    pub async fn post_newsletters(&self, body: serde_json::Value) -> reqwest::Response {
        self.api_client
            ...
            // reqwest doest heavy lifting for encoding and formatting
    ...
    pub fn get_confirmation_links(&self, email_request: &wiremock::Request) -> ConfirmationLinks {
        // Parse the body as JSON, starting from raw_bytes
